...
export const PLACES: Place[] = [
  ...
  { id: "ridgewatch", name: "Ridgewatch", tx: 250, ty: 48, radius: 16, kind: "ridge", blurb: "The north wall of the vale." },
  { id: "hearthfen", name: "Hearthfen", tx: 400, ty: 168, radius: 8, kind: "town", blurb: "Peat smoke and a single well." },
  ...
  { id: "brinegate", name: "Brinegate", tx: 470, ty: 420, radius: 8, kind: "town", blurb: "Salt air. The east water." },
];

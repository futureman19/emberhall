...
export interface GemEffect {
  ...
  readonly stat: "damage" | "hitBonus" | "fortune" | "armor" | "skill";
...
export function gemEffect(resourceId: GemResourceId, clarity: GemClarity): GemEffect {
  ...
  if (family !== "power" && family !== "fortune" && family !== "precision" && family !== "protection" && family !== "mastery") throw new Error(`${resourceId} has no deterministic gem family`);

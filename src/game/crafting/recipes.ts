...
export type ExactRecipeId = "bow" | "sword" | "shield" | "helm" | "mail" | "boots" | "gauntlets" | "greaves";
...
const EXACT_RECIPE_IDS = ["bow", "sword", "shield", "helm", "mail", "boots", "gauntlets", "greaves"] as const satisfies readonly ExactRecipeId[];

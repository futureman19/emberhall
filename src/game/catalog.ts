...
export const FAUNA_META: Record<FaunaKind, { label: string; tameDiff: number; hp: number; dmg: number; eats: ResourceTag[]; meat?: number; hide?: number; hasCorpse?: boolean; loot?: LootDrop[]; gold?: LootGold }> = {
  ...
  oak_bear: { label: "Oak Bear", tameDiff: 78, hp: 62, dmg: 13, eats: ["meat", "plant"], meat: 4, hide: 3, loot: [{ item: "ginseng", chance: 0.2, min: 1, max: 2 }] },
  frosthorn_ram: { label: "Frosthorn Ram", tameDiff: 46, hp: 34, dmg: 8, eats: ["plant"], meat: 2, hide: 2 },
  fen_leech: { label: "Fen Leech", tameDiff: 99, hp: 30, dmg: 9, eats: ["meat"], meat: 1, loot: [{ item: "nightshade", chance: 0.38, min: 1, max: 2 }, { item: "moss", chance: 0.25, min: 1, max: 1 }] },
  ...
  rime_revenant: { label: "Rime Revenant", tameDiff: 99, hp: 54, dmg: 13, eats: ["meat"], hasCorpse: false, loot: [{ item: "pearl", chance: 0.3, min: 1, max: 1 }, { item: "ash", chance: 0.25, min: 1, max: 2 }, { item: "relic", chance: 0.05, min: 1, max: 1 }], gold: { chance: 0.4, min: 4, max: 11 } },
  fen_ghoul: { label: "Fen Ghoul", tameDiff: 99, hp: 44, dmg: 11, eats: ["meat"], hasCorpse: false, loot: [{ item: "nightshade", chance: 0.35, min: 1, max: 2 }, { item: "moss", chance: 0.3, min: 1, max: 2 }, { item: "ring", chance: 0.05, min: 1, max: 1 }], gold: { chance: 0.25, min: 2, max: 7 } },
  drowned_reaver: { label: "Drowned Reaver", tameDiff: 99, hp: 58, dmg: 14, eats: ["meat"], hasCorpse: false, loot: [{ item: "sword", chance: 0.15, min: 1, max: 1 }, { item: "boots", chance: 0.15, min: 1, max: 1 }, { item: "pearl", chance: 0.35, min: 1, max: 2 }], gold: { chance: 0.5, min: 5, max: 12 } },
  deepmaw_basilisk: { label: "Deepmaw Basilisk", tameDiff: 99, hp: 72, dmg: 16, eats: ["meat"], meat: 3, hide: 3, loot: [{ item: "ore", chance: 0.35, min: 1, max: 2 }, { item: "nightshade", chance: 0.2, min: 1, max: 1 }] },

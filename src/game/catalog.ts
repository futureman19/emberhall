...
> = {
  ...
  club: { label: "Club", tool: true, slot: null, fill: "var(--color-gold)", armor: 0, buy: 10, sell: 6 },
  shield: { label: "Wooden shield", tool: false, slot: null, fill: "var(--color-gold)", armor: 0, buy: 18, sell: 10 },
  staff: { label: "Staff", tool: true, slot: null, fill: "var(--color-gold)", armor: 0, buy: 16, sell: 8 },
  bow: { label: "Bow", tool: true, slot: null, fill: "var(--color-gold)", armor: 0, buy: 22, sell: 10 },
  torch: { label: "Torch", tool: false, slot: null, fill: "var(--color-accent)", armor: 0, buy: 4, sell: 2 },
  ...
  sword: { label: "Sword", tool: true, slot: null, fill: "var(--color-muted)", armor: 0, buy: 36, sell: 16 },
  mace: { label: "Mace", tool: true, slot: null, fill: "var(--color-muted)", armor: 0, buy: 28, sell: 12 },
  ...
  heater: { label: "Iron shield", tool: false, slot: null, fill: "var(--color-muted)", armor: 0, buy: 32, sell: 14 },

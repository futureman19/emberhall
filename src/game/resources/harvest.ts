...
function yieldFor(identity: ResourceNodeIdentity, effectiveSkill: number): HarvestYield {
  ...
  if (definition.kind === "timber") {
    const resourceId = identity.resourceId as Exclude<HarvestResourceId, GemResourceId | "copper_ore" | "tin_ore" | "bronze" | "iron_ore" | "highland_ore" | "emberite" | "moon_silver" | "hide" | "wolf_fang" | "stag_antler" | "drake_scale">;

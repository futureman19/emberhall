...
type HarvestFormFor<I extends HarvestResourceId> = I extends GemResourceId
  ? "gem"
  : I extends "copper_ore" | "tin_ore" | "bronze" | "iron_ore" | "highland_ore" | "emberite"
    ? "ore"
    : "log";
...
function yieldFor(identity: ResourceNodeIdentity, effectiveSkill: number): HarvestYield {
  ...
  if (definition.kind === "timber") {
    const resourceId = identity.resourceId as Exclude<HarvestResourceId, GemResourceId | "copper_ore" | "tin_ore" | "bronze" | "iron_ore" | "highland_ore" | "emberite" | "hide">;
  ...
  if (definition.kind === "ore") {
    const resourceId = identity.resourceId as "copper_ore" | "tin_ore" | "bronze" | "iron_ore" | "highland_ore" | "emberite";

...
const out='art/verification/civic/hall-abba.json';assert(!fs.existsSync(out),'Preserve previous results');
const result={scope:'Current civic renderer in both arms, mobile hall interior, fixed fixture/noon/clear. Off aborts only new Phase1 props/signs. CPU render submission is NOT GPU execution time. Diagnostic does not waive original failed gates.',order:['off','on','on','off'],frames:300,runs:[],errors:[]};

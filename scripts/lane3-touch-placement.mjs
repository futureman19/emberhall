...
const out='art/lane3/touch-placement';fs.mkdirSync(out,{recursive:true});assert(!fs.existsSync(out+'/results.json'));
...
try{for(const kind of kinds){
 ...
 row.pointer=point;await p.touchscreen.tap(point.x,point.y);await p.waitForTimeout(200);
